...
gulp.task('rollup:umd', function () {
  ...
  // transform the files here.
    .pipe(rollup({
      ...
      moduleName: 'angular-window-component',
    ...
    .pipe(rename('angular-window-component.umd.js'))
    .pipe(gulp.dest(distFolder));
});
...
/**
 * 9. Copy templates from /src to /dist
 */
gulp.task('copy:templates', function () {
  return gulp.src([path.join(srcFolder, '*.html')])
    .pipe(gulp.dest(distFolder));
});

/**
 * 9. Copy styles from /src to /dist
 */
